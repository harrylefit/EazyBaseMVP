...
public abstract class EazyButton extends AppCompatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int type = 1;
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.EazyButton);
            type = typedArray.getInt(R.styleable.EazyButton_ebt_font, 1);
            boolean enableChangeSize = typedArray.getBoolean(R.styleable.EazyButton_ebt_enableChangeSize, true);
            if (enableChangeSize) {
